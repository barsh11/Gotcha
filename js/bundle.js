...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.renderWinner = exports.renderCurrentScore = exports.renderFinalScore = exports.renderActivePlayer = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar renderActivePlayer = exports.renderActivePlayer = function renderActivePlayer(currplayer) {\n    _base.elements.player0.classList.toggle(_base.elementsStrings.activeClass);\n    _base.elements.player1.classList.toggle(_base.elementsStrings.activeClass);\n};\n\nvar renderFinalScore = exports.renderFinalScore = function renderFinalScore(player, score) {\n    document.querySelector('#score-' + player).textContent = score;\n};\n\nvar renderCurrentScore = exports.renderCurrentScore = function renderCurrentScore(player, score) {\n    document.querySelector('#current-' + player).textContent = score;\n};\n\nvar renderWinner = exports.renderWinner = function renderWinner(gotchaCard, winner) {\n    gotchaCard.classList.add('card__winner');\n    var heading = document.createElement('h2');\n    if (winner === 0) {\n        heading.textContent = 'yay! it\\'s a tie';\n    } else {\n        heading.textContent = 'player ' + winner + ' won!';\n    }\n    heading.classList.add('h2-heading');\n    setTimeout(function () {\n        gotchaCard.insertAdjacentElement('afterbegin', heading);\n    }, 1000);\n};\n\n//# sourceURL=webpack:///./src/js/views/scoresView.js?");
